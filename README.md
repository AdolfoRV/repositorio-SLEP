...
Este proyecto fue desarrollado como parte de un trabajo semestral para la **Universidad de Chile**, con el objetivo de modernizar y automatizar la gestión de licencias médicas de la organización **SLEP Los Libertadores**.

## 🚩 El Problema

La organización dependía de un sistema de registro basado en hojas de cálculo (Excel) que presentaba graves problemas de escalabilidad y calidad de datos:
...
## 🎓 Créditos
Desarrollado por **Adolfo Rojas Valenzuela** como proyecto académico para la Universidad de Chile.
