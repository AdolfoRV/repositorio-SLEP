...
# Catálogo de reglas de negocio y estandarizaciones
...
## RB-01 — Normalización canónica de texto (`norm`)
...
## RB-02 — Normalización de RUT (`norm_rut`)
...
## RB-03 — Errores de Excel tratados como vacío
...
## RB-04 — Clasificación en cascada: regex → fuzzy → revisar
...
## Estandarización — Tipos de licencia (`RE_TIPO`)
...
## Estandarización — Instituciones de salud (`RE_INST`)
...
## Estandarización — Resolución médica (`RE_RESOL` y RB-05)
...
## Estandarización — Establecimientos (`RE_ESTABLECIMIENTO` y RB-08)
...
## Estandarización — AFP (`AFP_MAP`, RB-06 y RB-07)
...
## Identificación del funcionario (RB-09)
...
## Montos dobles: Sistema vs. Pagado (RB-11)
...
## Catálogo de estados de migración
...
## `04_Hechos_Licencias.xlsx` en detalle
...
## Qué es un `.pbit` y cómo se relaciona con `slep`
...
## Consultas Power Query (origen de cada tabla)
...
### `Dim_Funcionario` ← `01_Dim_Funcionario.xlsx`
...
### `Hechos_Licencias` ← `04_Hechos_Licencias.xlsx`
...
### `Hechos_Descuentos` ← `05_Hechos_Descuentos.xlsx`
...
### `Dim_Calendario` (tabla calculada, sin archivo de origen)
...
## Consulta de auditoría de calidad (no cargada al modelo)
...
### Por qué la relación Licencias↔Descuentos es bidireccional
...
### Montos: recuperación y brecha Sistema vs. Pagado
...
### Alertas de ausentismo prolongado (ventana móvil de 24 meses)
...
### Página "Ficha Funcionario" (destino de *drillthrough*)
...
### Si `slep` cambia el nombre o la ubicación de un archivo de salida
...
### Si se agrega o renombra una columna en un Excel de salida
...
### Si cambia el umbral o la ventana de alertas (180 días / 24 meses)
...
### Si se agrega una categoría nueva de `Resolucion Medica`
...
### Regenerar la plantilla desde cero
...
## Riesgos conocidos y limitaciones del dashboard
...
## Mantenimiento del código (requiere clonar el repositorio)

> **Audiencia**: equipo de desarrollo o TI que mantiene el paquete `slep`.

### Agregar o corregir un establecimiento
...
### Agregar un tipo de licencia, institución o estado
...
### Incorporar un nuevo año de datos
...
### Convenciones para escribir regex nuevas (TI)
...
## Mantenimiento de las salidas (sin clonar el repositorio)
...
### Agregar o corregir una AFP o su tasa
...
### Imputar una nueva licencia médica
...
### Agregar o corregir descuentos mensuales
...
### Ciclo de trabajo para usuarios finales
